...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    tag: "Announcement",
    content: [
      "Today we're opening applications for the Lucentaa pilot program — a structured, low-risk way for imaging departments to evaluate our AI-assisted review platform against their own studies before any wider rollout.",
      "The pilot is designed around a simple principle: nothing should be taken on faith. Partner sites work with our clinical team to define success criteria up front, run Lucentaa alongside their existing workflow, and review performance together on a regular cadence.",
  ...
  },
  {
    ...
    excerpt:
      "Clinical advisors have been part of Lucentaa since the earliest research prototypes. Here's why that mattered from day one.",
    date: "2026-09-16",
    tag: "Engineering",
    content: [
      ...
      "It's also shaped how we talk about the technology. We describe Lucentaa's AI capabilities as in development and pilot stage because that's what's true today, not because it reads well on a website. As the platform matures through pilots, we'll update that language to match — but only as the evidence supports it.",
    ],
  },
];
